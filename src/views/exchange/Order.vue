<template>
  <div>
		<Row class="switchTab">
			<Col span="3">
				<Button long :type="btnType===0 ? 'primary' : 'ghost'" @click="localEnsure">当前委托</Button>
			</Col>
			<Col span="3" offset="1">
				<Button long :type="btnType===1 ? 'primary' : 'ghost'" @click="hisEnsure">历史委托</Button>
			</Col>
		</Row>
    <Card>
        <p slot="title">
      ...
      <Row class="priceSectionWrapper clearfix" >
        ...
        <div class="orderStatus">
          <span>挂单类型：</span>
          <Select v-model="filterSearch.type" style="width:100px">
