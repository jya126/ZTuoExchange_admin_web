    ...
    return {
      ...
      assetColumns: [
        ...
        },
        {
          ...
          key: "balance",
          render:(h,param)=>{
            return h('span',this.numToFixed(param.row.balance||0, param.row.coin.withdrawScale))
          }
        },
        {
          title: "冻结",
          ...
          key: "frozenBalance",
          render:(h,param)=>{
            return h('span',this.numToFixed(param.row.frozenBalance||0, param.row.coin.withdrawScale))
          }
        },
        {
          title: "待释放资产",
          ...
          key: "toReleased",
          render:(h,param)=>{
            return h('span',this.numToFixed(param.row.toReleased||0, param.row.coin.withdrawScale))
          }
        },
        {
          title: "地址",
